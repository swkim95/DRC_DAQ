...
void CALTCBwrite_DRAM_DLY(int sid, unsigned long mid, int ch, int data);
...
void CALTCBwrite_DRS_OFS(int sid, unsigned long mid, unsigned long ch, unsigned long rofs, unsigned long oofs)
{
  unsigned long data;
  unsigned long addr = 0x20;
  addr += ((ch - 1) & 0xFF) << 8;
...
int CALTCB_DRSinit(int sid, unsigned long mid)
{
  ...
  CALTCBwrite_DRS_OFS(sid, mid, 1, 3075, 2400);
  CALTCBwrite_DRS_OFS(sid, mid, 2, 3075, 2400);
  CALTCBwrite_DRS_OFS(sid, mid, 3, 3075, 2400);
  CALTCBwrite_DRS_OFS(sid, mid, 4, 3075, 2400);
