...
int plot_waveform_4ch(void)
{
  ...
  TH1F *plot2 = new TH1F("plot2", "Waveform ch3", 1000, 0, 200); 
  TH1F *plot3 = new TH1F("plot3", "Waveform ch5", 1000, 0, 200); 
  TH1F *plot4 = new TH1F("plot4", "Waveform ch7", 1000, 0, 200); 
  plot1->SetStats(0);
  plot2->SetStats(0);
  plot3->SetStats(0);
  plot4->SetStats(0);
...
//      plot->Fill(i, adc[i * 32 + ch_to_plot]);         // org
    for (i = 0; i < 1000; i++) {                      // mod
      ...
      plot2->Fill(i * 0.2, adc[(i + 1) * 32 + 2]);         // mod
      plot3->Fill(i * 0.2, adc[(i + 1) * 32 + 4]);         // mod
      plot4->Fill(i * 0.2, adc[(i + 1) * 32 + 6]);         // mod
